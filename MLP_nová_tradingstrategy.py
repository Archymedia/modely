...
def create_comprehensive_visualization(history, portfolio_tracking_df, best_params, train_metrics, test_metrics, trading_metrics):
...
def main():
    ...
    try:
        ...
        output_file = create_comprehensive_visualization(
            history, portfolio_tracking_df, best_params, train_metrics, test_metrics, trading_metrics)
