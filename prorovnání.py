...
# Data path - updated for your location
data_path = r"C:\Users\david\Desktop\SP100\Reuters_SP100_Data.csv"

print(f"Loading data from: {data_path}")
if not os.path.exists(data_path):
    raise FileNotFoundError(f"Could not find the S&P100 data file at: {data_path}")
